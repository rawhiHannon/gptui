  ...
  return (
    ...
    <div className="chat-preview" style={{ backgroundColor: agent.ChatBackgroundColor }}>
      ...
      <div id="js-chatbox-email-input">
        <h3 style={{textAlign: 'center', color: '#333333'}}>Signup with your email</h3>
        <img src="https://agentbuddy.xseed.me/logo.png" alt="" className="chatbox-image" id="chatbox-logo" />
        ...
        <p>Or <span id="js-chatbox-toggle-phone">Get a confirmation code sent to your phone.</span></p>
      </div>
